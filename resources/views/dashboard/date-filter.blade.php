  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form id="paginate_form" action="{{route('prev_date_paginator',["startDate"=>$startDate,"endDate"=>$endDate])}}" method="POST">  
              @csrf
            @if($prev_link != "")
     ...
     &nbsp;
        ...
        <form id="paginate_form2" action="{{route('next_date_paginator',["startDate"=>$startDate,"endDate"=>$endDate])}}" method="POST">
          @csrf 
          @if($next_link != "")
          <button type="submit" class="btn btn-sm btn-primary">></button>
             ...
             @endif
              ...
              @include('includes.datepicker')
               ...
               <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h2 class="card-title"> Ad Accounts <span style="color:#4056F4">&nbsp;{{$startDate}}&nbsp;&nbsp;to &nbsp;&nbsp;{{$endDate}} </span></h2>
